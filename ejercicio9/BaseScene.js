...
class BaseScene extends THREE.Scene {
    ...
    ambientLight;
    pointLight;
    static POINT_LIGHT_POSITION = [0.3, 0.9, 0.5];
    ...
    static CAMERA_POSITION = [0.15, 0.45, 0.55];
    ...
    // Ground
    ground;
    static GROUND_GEOMETRY = [0.8, 0.02, 0.8];
