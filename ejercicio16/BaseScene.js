...
class BaseScene extends THREE.Scene {
    // Renderer
    renderer;
    static RENDERER_CLEAR_COLOR = 0x222228;
    ...
    gui;
    guiControls;
    static SUN_INTENSITY = 1.2;
    static SUN_INTENSITY_MIN = 0.0;
    static SUN_INTENSITY_MAX = 4.0;
    ...
    static CAMERA_POSITION = [0, 0.3, 2.2];
    static CAMERA_LOOK_AT = [0, 0.25, 0];
    ...
    constructor(myCanvas) {
        ...
        this.model = new Materials(this.gui);
        this.add(this.model);
    }
    ...
    createGUI() {
        ...
        basicFolder.add(this.guiControls, 'sunIntensity', BaseScene.SUN_INTENSITY_MIN, BaseScene.SUN_INTENSITY_MAX, 0.05)
            .name('Sun: ')
    ...
    createLights() {
        ...
        this.sun = new THREE.DirectionalLight('white', this.guiControls.sunIntensity);
